...
- Заметки поддерживают rich-text, горячие клавиши, режим просмотра перед редактированием, прикреплённые файлы до 10 MB и предпросмотр изображений в popup. Остальные типы файлов скачиваются.
