...
const DRINK_QUALITY = {
  0:  { appearance: 'Коричнево-чёрный напиток с плотной рыжевато-золотистой кремаой 5–10 мм', consistency: 'Плотная, устойчивая пена-крема', color: 'Тёмно-коричневый с рыжево-золотистыми прожилками кремы', taste: 'Насыщенный, баланс горечи и сладости, типичный кофейный аромат' },
...
function exportTechCards() {
  ...
  ${(function(){
    ...
    if (!q) return '<p style="color:#999;font-size:9pt">Показатели не заполнены</p>';
    return `<table class="qa">
