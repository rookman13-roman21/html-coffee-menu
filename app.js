...
const DRINKS = [
  ...
  { id:16, group:'hot',  name:'Ванильное облако 300',   vol:300,
    recipe:[{mat:'coffee',amt:19},{mat:'cream',amt:100},{mat:'sugar_van',amt:5},{mat:'cup350',amt:1}], price:330,
  ...
  { id:18, group:'tea',  name:'Матча 300',              vol:300,
    recipe:[{mat:'matcha',amt:5},{mat:'milk',amt:250},{mat:'cup350',amt:1}], price:330,
  ...
  { id:19, group:'tea',  name:'Матча 400',              vol:400,
    recipe:[{mat:'matcha',amt:7},{mat:'milk',amt:350},{mat:'cup450',amt:1}], price:390,
  ...
  { id:25, group:'cold', name:'Бамбл 500',              vol:500,
    ...
    process:'Выжать свежий апельсиновый сок (~245 мл из 490 г апельсинов). Стакан наполнить льдом, влить сок. Приготовить двойной эспрессо (19 г, 50–60 мл). Медленно влить горячий эспрессо поверх сока — эффект «закат». Не перемешивать. Подавать с трубочкой.' },
  ...
  _costEl.innerHTML = `
    ...
    <div class="tab-intro" id="sup-intro">
      ...
      <div>
        ...
        <div class="tab-intro-text">
          Здесь живёт база всего, из чего делаются напитки. Три секции:
          <strong>Поставщики</strong> — справочник контрагентов, привязанных к конкретному сырью;
          <strong>Ингредиенты</strong> — цены на сырьё, при изменении которых себестоимость всех рецептур пересчитывается мгновенно;
          <strong>Полуфабрикаты</strong> — заготовки со своей рецептурой (сиропы, соусы, смеси), которые можно использовать как ингредиент в напитках.
        </div>
        <div class="tab-intro-steps">
          <span class="tab-intro-step">Добавь поставщиков и привяжи их к ингредиентам — контакт всегда под рукой</span>
          <span class="tab-intro-step">Обновляй цены сырья после каждой закупки — вся экономика пересчитается сама</span>
          <span class="tab-intro-step">Создай полуфабрикат (например «Карамельный соус») и используй его в рецептурах напитков</span>
          <span class="tab-intro-step">История цен — иконка 🕐 рядом с ингредиентом сохраняет все изменения</span>
        </div>
      </div>
    </div>
