...
- Заметки поддерживают rich-text редактор, горячие клавиши, типы заметок, закрепление, отдельный режим просмотра перед редактированием и файлы до 10 MB: PDF, DOCX, XLSX, CSV, TXT, PNG, JPG/JPEG, WebP. Владелец может удалить любой файл заметки, участник — только свой.
