...
Дата актуализации: 23 июня 2026.
...
- Журнал действий append-only: фиксирует вход/переключение проекта, приглашения, локации, бюджет открытия, финмодель/ФОТ, план продаж, рецепты, поставщиков и экспорты. Autosave сам по себе не логируется.
