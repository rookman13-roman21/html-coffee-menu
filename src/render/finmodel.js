    ...
    <div class="tab-intro" id="fin-intro">
      ...
      <div>
        ...
        <div class="tab-intro-text">
          Страница строит полную финансовую картину кофейни: <strong>дашборд</strong> с ключевыми KPI, <strong>P&amp;L-отчёт</strong> (выручка → себестоимость → постоянные расходы → ФОТ → налог → чистая прибыль), <strong>три сценария</strong> и <strong>прогноз на год</strong>.<br>
          Все данные пересчитываются автоматически при любом изменении меню, порций или расходов.
        </div>
        <div class="tab-intro-steps">
          <span class="tab-intro-step">1. Внеси постоянные расходы по категориям (аренда, коммуналка, реклама…)</span>
          <span class="tab-intro-step">2. Настрой ФОТ: добавь должности и выбери схему оформления</span>
          <span class="tab-intro-step">3. Укажи стартовые вложения → появится срок окупаемости</span>
          <span class="tab-intro-step">4. Выбери режим налогообложения → P&amp;L пересчитается</span>
          <span class="tab-intro-step">5. Pricing wizard: подвигай цены и трафик — смотри как меняется прибыль</span>
          <span class="tab-intro-step">6. Сезонность: пресеты БЦ, ЖК, лето — прогноз выручки на 12 мес</span>
        </div>
      </div>
    </div>
