...
export const DRINKS = [
  ...
  { id:17, group:'tea',  name:'Чай в ассортименте 300', vol:300,
    ...
    process:'Прогреть чайник кипятком, слить воду. Засыпать 5 г чая в заварник или фильтр. Залить 300 мл воды: зелёный и белый — 80°C, чёрный и травяной — 90–95°C. Время заваривания 2–4 минуты в зависимости от сорта. Подавать сразу.' },
